...
namespace Plugins.Verpha.Hierarchy_Designer.Editor.Scripts
{
    internal static class HierarchyDesigner_Configurable_DesignSettings
    {
        ...
        private class HierarchyDesigner_DesignSettings
        {
            ...
            public Color HierarchyLineColor = HierarchyDesigner_Shared_Color.HexToColor("00000080");
            ...
            public HierarchyDesigner_Configurable_Folders.FolderImageType FolderDefaultImageType = HierarchyDesigner_Configurable_Folders.FolderImageType.Default;
            #endregion
        ...
        public static HierarchyDesigner_Configurable_Folders.FolderImageType FolderDefaultImageType
        {
        ...
        public static HierarchyDesigner_Configurable_Separators.SeparatorImageType SeparatorDefaultImageType
        {
        ...
        {
            string dataFilePath = HierarchyDesigner_Shared_File.GetSavedDataFilePath(HierarchyDesigner_Shared_Constants.DesignSettingsTextFileName);
        ...
        private static void SetDefaultSettings()
        {
            designSettings = new()
            {
                ...
                TagLayerOffset = 5,
                TagLayerSpacing = 5,
                HierarchyLineColor = HierarchyDesigner_Shared_Color.HexToColor("00000080"),
                ...
                FolderDefaultImageType = HierarchyDesigner_Configurable_Folders.FolderImageType.Default,
