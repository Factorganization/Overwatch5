...
namespace Plugins.Verpha.Hierarchy_Designer.Editor.Scripts
{
    internal static class HierarchyDesigner_Configurable_AdvancedSettings
    {
        ...
        private static HierarchyDesigner_AdvancedSettings advancedSettings = new();
        #endregion
        ...
        {
            string filePath = HierarchyDesigner_Shared_File.GetScriptsFilePath("HierarchyDesigner_Shared_Constants.cs");
        ...
        {
            string dataFilePath = HierarchyDesigner_Shared_File.GetSavedDataFilePath(HierarchyDesigner_Shared_Constants.AdvancedSettingsTextFileName);
        ...
        public static void LoadSettings()
        {
            ...
            if (File.Exists(dataFilePath))
            {
                ...
                loadedSettings.HierarchyLocation = HierarchyDesigner_Shared_Checker.ParseEnum(loadedSettings.HierarchyLocation.ToString(), HierarchyDesignerLocation.Tools);
                loadedSettings.MainIconUpdateMode = HierarchyDesigner_Shared_Checker.ParseEnum(loadedSettings.MainIconUpdateMode.ToString(), UpdateMode.Dynamic);
                loadedSettings.ComponentsIconsUpdateMode = HierarchyDesigner_Shared_Checker.ParseEnum(loadedSettings.ComponentsIconsUpdateMode.ToString(), UpdateMode.Dynamic);
                loadedSettings.HierarchyTreeUpdateMode = HierarchyDesigner_Shared_Checker.ParseEnum(loadedSettings.HierarchyTreeUpdateMode.ToString(), UpdateMode.Dynamic);
                loadedSettings.TagUpdateMode = HierarchyDesigner_Shared_Checker.ParseEnum(loadedSettings.TagUpdateMode.ToString(), UpdateMode.Dynamic);
                loadedSettings.LayerUpdateMode = HierarchyDesigner_Shared_Checker.ParseEnum(loadedSettings.LayerUpdateMode.ToString(), UpdateMode.Dynamic);
