...
namespace Plugins.Verpha.Hierarchy_Designer.Editor.Scripts
{
    internal static class HierarchyDesigner_Configurable_GeneralSettings
    {
        ...
        private static HierarchyDesigner_GeneralSettings generalSettings = new();
        #endregion
        ...
        {
            string dataFilePath = HierarchyDesigner_Shared_File.GetSavedDataFilePath(HierarchyDesigner_Shared_Constants.GeneralSettingsTextFileName);
        ...
        public static void LoadSettings()
        {
            ...
            if (File.Exists(dataFilePath))
            {
                ...
                loadedSettings.LayoutMode = HierarchyDesigner_Shared_Checker.ParseEnum(loadedSettings.LayoutMode.ToString(), HierarchyLayoutMode.Docked);
                loadedSettings.TreeMode = HierarchyDesigner_Shared_Checker.ParseEnum(loadedSettings.TreeMode.ToString(), HierarchyTreeMode.Default);
